...
curl -X GET 'http://secure-woodland-74914.herokuapp.com/banks/?limit=10&offset=20' && echo "1 - Bank List"
curl -H 'Accept: application/json' -H "Authorization: Bearer ${TOKEN}" -X GET 'http://secure-woodland-74914.herokuapp.com/branchlist/?limit=15&offset=15' && echo "2 - Branches List"
